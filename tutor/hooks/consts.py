...
class Actions:
    ...
    To create a new callback for an existing action, write the following::
        ...
        @hooks.actions.on(hooks.Actions.YOUR_ACTION_NAME)
        def your_action():
            # Do stuff here
    """
    ...
    CORE_ROOT_READY = "core:root:ready"
...
class Filters:
    ...
    To add custom data to any filter, write the following in your plugin::
        ...
        @hooks.filters.add(hooks.Filters.YOUR_FILTER_NAME)
    ...
    APP_TASK_IMAGES_BUILD = "app:tasks:images:build"
    ...
    APP_TASK_PRE_INIT = "app:tasks:pre-init"
    ...
    ENV_TEMPLATE_ROOTS = "env:templates:roots"
    ...
    #:   subfolder.
    ENV_TEMPLATE_TARGETS = "env:templates:targets"
    ...
    PLUGINS_INFO = "plugins:installed:versions"
